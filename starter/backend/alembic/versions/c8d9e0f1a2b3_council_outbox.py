...
def upgrade() -> None:
    ...
    council_state_column = postgresql.ENUM(
        "RUNNING", "SUCCEEDED", "FAILED", name="council_output_state", create_type=False
    )
    ...
    op.create_table("council_outputs",
        ...
        sa.Column("specialist", sa.String(), nullable=False), sa.Column("model_version", sa.String(), nullable=False), sa.Column("state", council_state_column, nullable=False),
