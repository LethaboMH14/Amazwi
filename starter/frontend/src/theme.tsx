...
export function ThemeProvider({children}:{children:ReactNode}){const [theme,setTheme]=useState<Theme>(()=>{const saved=localStorage.getItem("amazwi.theme");return saved==="daylight"?"daylight":"midnight";});useEffect(()=>{document.documentElement.dataset.theme=theme;if(theme!=="ndebele")localStorage.setItem("amazwi.theme",theme);},[theme]);return <ThemeContext.Provider value={{theme,setTheme}}>{children}</ThemeContext.Provider>;}
