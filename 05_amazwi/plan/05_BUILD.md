...
If approval is absent, do not put product-specific application code in the repo before the event. Research, content and documentation remain distinct from the competition implementation.
